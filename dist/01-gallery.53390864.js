...
const getMurkupImages = (list)=>{
    return list.reduce((nodes, { preview , original , description  })=>nodes += `<a class="gallery__item" href="${original}">
...
galleryRef.insertAdjacentHTML("beforeend", getMurkupImages((0, _galleryItems.galleryItems)));
const options = {
    captionDelay: 250
};
let lightbox = new (0, _simplelightboxDefault.default)(".gallery .gallery__item", options);
